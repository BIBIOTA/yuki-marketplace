...
- [ ] 1.1 移植 `requesting-code-review/SKILL.md`（忠實移植 + `<language>` 區塊 + 輕量 pipeline 整合）
...
- [ ] 2.1 移植 `receiving-code-review/SKILL.md`（忠實移植 + `<language>` 區塊）
...
## 3. 註冊
- [ ] 3.1 在 Claude plugin manifest 註冊兩個 skill
