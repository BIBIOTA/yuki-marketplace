...
- [ ] 1.1 Add the Codex marketplace entry
...
- [ ] 1.2 Add the `yuki-toolkit` Codex plugin manifest
...
- [ ] 1.3 Add the `spec-driven-dev` Codex plugin manifest
...
- [ ] 2.1 Preserve Claude plugin metadata
  ...
  - Depends on: -
  - Independence: independent
- [ ] 2.2 Verify Codex handling for the running coach agent
  ...
  - Depends on: 1.2
  - Independence: serial
- [ ] 2.3 Add a thin running coach skill wrapper only if required
...
## 3. Documentation
- [ ] 3.1 Update README with Codex installation instructions
  ...
  - Independence: serial
- [ ] 3.2 Document the shared-maintenance rule
  ...
  - Depends on: 3.1
  - Independence: serial
- [ ] 3.3 Document version maintenance expectations
...
- [ ] 4.1 Validate manifest JSON
  ...
  - Depends on: 1.1, 1.2, 1.3
  - Independence: parallel-safe
- [ ] 4.2 Validate shared path references
  ...
  - Depends on: 1.2, 1.3
  - Independence: parallel-safe
- [ ] 4.3 Run a Codex marketplace smoke test
  ...
  - Independence: serial
- [ ] 4.4 Verify README completion criteria
